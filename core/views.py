...
class ItemDetailView(DetailView):
    model = Item
    # def get(self, *args, **kwargs):
    #     category = Item.objects.get(slug=self.kwargs['slug']).category
    #     print(category)
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                order.ordered = True
                order.save()
                messages.success(self.request, "Order was successful. Item will be shipped to your address. Pay on delivery. Thank you !")
